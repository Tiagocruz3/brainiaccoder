...
echo "Starting Brainiac Coder update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/stackblitz-labs/brainiac-coder/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
